...
/** Напишите приложение, которое будет запрашивать у пользователя следующие данные, разделенные пробелом:
        ...
        Форматы данных: фамилия, имя, отчество - строки (String)
        дата рождения - строка формата (dd.mm.yyyy)
        номер телефона - целое беззнаковое число без форматирования
        пол - символ латиницей f или m. (char)
    Приложение должно проверить введенные данные по количеству. Если количество не совпадает с требуемым,
 вернуть код ошибки или бросить исключение, обработать его и показать пользователю сообщение, что он ввел меньше
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                ReceiverData.getPersonData(person);
                // Сохраняем в файл
                SaveData.savePersonData(person);

                System.out.println("Данные успешно сохранены.");
                // Выходим из бесконечного цикла
                break;
            } catch (RuntimeException e) {
                // ReceiverData.getPersonData при проблеме с валидацией данных выбрасывает исключение, которое выводим здесь
